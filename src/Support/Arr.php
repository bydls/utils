...
class Arr
{
     ...
     * @return array
     */
    public static function access($data):array
    {
     ...
     * @Time: 2020/6/3   13:36
     */
    public static function twoDimensionalSort(array $array, $on, $order = SORT_ASC)
    {
        if (!$array) {
            return [];
        }
     ...
     */
    public static function toObject(array $arr, $json = false): object
    {
        if ($json) {
